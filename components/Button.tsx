...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  // High-density professional styles
  const baseStyles = "rounded-lg font-semibold transition-all duration-200 flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed tracking-tight";
  ...
  const variants = {
    // Sharp Indigo
    primary: "bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm hover:shadow border border-transparent focus:ring-indigo-500",
    // Clean Paper

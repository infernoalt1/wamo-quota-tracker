        ...
        <div className="p-6 border-b border-slate-100 flex justify-between items-start bg-slate-50/50">
           <div>
              ...
              <div className="flex gap-3 text-xs text-slate-500 mt-2">
                 <span className="font-mono bg-slate-100 px-1.5 py-0.5 rounded">Diff: {problem.difficulty}</span>
                        ...
                        comments.map(c => (
                            <div key={c.id} className="bg-white p-3 rounded-lg border border-slate-100 shadow-sm">
                                <div className="flex justify-between items-center mb-1">
                                    <span className="font-bold text-xs text-indigo-700">{c.userName}</span>
